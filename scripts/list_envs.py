...
All the environments are registered in the `hanford_arm_isaaclab` extension. They start
...
def main():
    """Print all environments registered in `hanford_arm_isaaclab` extension."""
